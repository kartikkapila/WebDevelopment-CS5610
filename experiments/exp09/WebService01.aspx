...
<body>
    <div class="container">
        ...
        <pre>
                ...
                $.ajax({
                    url: "http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=[my_api_key]&q=" + search_variable + "&page-limit=5",
                    dataType: "jsonp",
        ...
        <p>Here, we use the url provided by the api along with the key given. To that we add the movie to be search, which we get by using the val()
            on the object that we have grabbed from dom, which represents the search-bar.
        </p>
        ...
        <div>
             <h3>Source</h3>
             <a href="../../fileview/Default.aspx?~/experiments/exp09/WebService01.aspx">ASPX Source</a>
        </div>
    </div>
